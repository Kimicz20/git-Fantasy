    ...
    _throttle_limit(1.0f)
{
	...
	_spin_when_armed = AP_MOTORS_SPIN_WHEN_ARMED;
	...
	_batt_voltage_max = AP_MOTORS_THST_BAT_MAX_DEFAULT;
	_batt_voltage_min = AP_MOTORS_THST_BAT_MIN_DEFAULT;
	_batt_current_max= AP_MOTORS_CURR_MAX_DEFAULT;
	_thr_mix_min = AP_MOTORS_THR_MIX_MIN_DEFAULT;
	_thr_mix_max = AP_MOTORS_THR_MIX_MAX_DEFAULT;
