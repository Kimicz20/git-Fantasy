...
void Copter::read_radio()
{
    ...
    /* 起始插桩路径记录 */
    long start = clock();
    this->supt->deal("has_new_input",start,1);
    /* 参数重定向 */
    has_new_input = this->supt->getParamValueWithNameAndKey("has_new_input","new_input");
    /* 结束插桩路径记录 */
    long end = clock();
    this->supt->deal("has_new_input",end,2);
    this->supt->deal("has_new_input",(end-start),3);
    ...
    if (has_new_input==true) {
        ...
        /* 起始插桩路径记录 */
        start = clock();
        this->supt->deal("set_pwm",start,1);
        ...
        this->supt->deal("set_pwm",end,2);
        this->supt->deal("set_pwm",(end-start),3);

        /* 起始插桩路径记录 */
        start = clock();
        this->supt->deal("set_throttle_and_failsafe",start,1);
        ...
        this->supt->deal("set_throttle_and_failsafe",end,2);
        this->supt->deal("set_throttle_and_failsafe",(end-start),3);

        /* 起始插桩路径记录 */
        start = clock();
        this->supt->deal("set_throttle_zero_flag",start,1);
        ...
        this->supt->deal("set_throttle_zero_flag",end,2);
        this->supt->deal("set_throttle_zero_flag",(end-start),3);
        ...
        if (elapsed >= FS_RADIO_TIMEOUT_MS && g.failsafe_throttle && failsafe.radio==0) {
            ...
            /* 起始插桩路径记录 */
            start = clock();
            this->supt->deal("set_failsafe_radio",start,1);
            ...
            this->supt->deal("set_failsafe_radio",end,2);
            this->supt->deal("set_failsafe_radio",(end-start),3);
        }
    }
}
