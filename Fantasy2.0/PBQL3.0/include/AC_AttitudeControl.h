...
public:
	AC_AttitudeControl( AP_AHRS &ahrs,
	    ...
	    _throttle_in_filt(AC_ATTITUDE_CONTROL_ALTHOLD_LEANANGLE_FILT_HZ)
		{
			...
			//用户可设定参数的初始化。
			_slew_yaw = AC_ATTITUDE_CONTROL_SLEW_YAW_DEFAULT;
			_accel_yaw_max = AC_ATTITUDE_CONTROL_ACCEL_Y_MAX_DEFAULT;
			_rate_bf_ff_enabled = AC_ATTITUDE_CONTROL_RATE_BF_FF_DEFAULT;
			_accel_roll_max = AC_ATTITUDE_CONTROL_ACCEL_RP_MAX_DEFAULT;
			_accel_pitch_max = AC_ATTITUDE_CONTROL_ACCEL_RP_MAX_DEFAULT;
			// initialise flags
